 ...
 */
final class Version20230228093417 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD image VARCHAR(255) DEFAULT \'\', ADD updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
    }
}
