...
class EvenementController extends AbstractController
{
    ...
    public function edit(Request $request,$id,TwilioService $twilioService): Response
    ...
    public function participer($id): Response
    {
        ...
        $user = $this->getUser() ;
        $dejaParticipe = ($event->getUsers()->contains($this->getUser()));
        if ($event->getNbrParticipant() > 0 and !($dejaParticipe) ) {
        ...
        return $this->render('evenement/frontShow.html.twig', [
            'p'=>$event,
            'id'=>$id,
            'nbr'=>$nbr= $event->getNbrParticipant(),
            'deja'=> $dejaParticipe ,
        ]);
    }
